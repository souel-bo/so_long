...
int	color_t_game_1(void *win,int w,int h);
int	color_t_game_2(unsigned char *data,int bpp,int sl,int w,int h,int endian, int type);
...
int	main()
{
  ...
  printf(" => Colort_game sans event ...");
  color_t_game_1(win1,WIN1_SX,WIN1_SY);
  printf("OK\n");
  sleep(2);
  ...
  printf(" => Image1 ZPixt_game %dx%d ...",IM1_SX,IM1_SY);
  ...
  printf(" => Fill Image1 ...");
  color_t_game_2(data1,bpp1,sl1,IM1_SX,IM1_SY,endian1, 1);
  printf("OK (pixt_game : %d)\n",(int)((t_img *)im1)->pix);
  ...
  printf(" => Image3 ZPixt_game %dx%d ...",IM3_SX,IM3_SY);
  ...
  printf(" => Fill Image3 ...");
  color_t_game_2(data3,bpp3,sl3,IM3_SX,IM3_SY,endian3, 1);
  printf("OK (pixt_game : %d)\n",(int)((t_img *)im3)->pix);
  ...
  color_t_game_2(data4,bpp4,sl4,IM3_SX,IM3_SY,endian4, 2);
